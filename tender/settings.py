...
SECRET_KEY = 'django-insecure-2q)^13kikogzr6_!uh#2el_qvj^t87f4&5+ln(7b+0ifi4m_$c'
...
ASGI_APPLICATION = 'tender.asgi.application'
...
DATABASES = {
  'default': {
    ...
    'USER': 'codewithyembot',
    'PASSWORD': '<% PASSWORD %>',
    'HOST': 'ep-calm-bird-974759.us-east-2.aws.neon.tech',
    'PORT': '5432',
  }
}
...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'tender.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'tender.storage_backends.PublicMediaStorage'
    # s3 private media settings
    PRIVATE_MEDIA_LOCATION = 'private'
    PRIVATE_FILE_STORAGE = 'tender.storage_backends.PrivateMediaStorage'
else:
    STATIC_URL = '/staticfiles/'
    STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
    MEDIA_URL = '/mediafiles/'
